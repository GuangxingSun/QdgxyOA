			...
			<div id="CenterArea">
				...
				<div id="LoginInfo">
					<table border=0 cellspacing=0 cellpadding=0 width=100%>
						<tr>
							<td colspan="2"><div style="color:red"><s:fielderror /></div></td>
						</tr>
						<tr>
							...
							<td rowspan="2" style="padding-left:10px;">
								<input type="image" src="${pageContext.request.contextPath}/style/blue/images/login/userLogin_button.gif" />
							</td>
						</tr>
						<tr>
							<td class="Subject">
				...
				<div id="CopyRight">
					<a href="javascript:void(0)">&copy; 2015 版权所有 青岛工学院</a>
				</div>
			</div>
		</div>
